...
export default function EncounterTableEntry({ encounter, idx, loading = false, showLocalPlayerDetails = false, disableNavigation = false, onRowClick }: Props) {
...
export function StatCard({ label, value, accent }: { label: string; value: string | number; accent: "purple" | "red" | "green" | "slate" | "white" }) {
